...
const catalog = {
  ...
  siteTypes: [
    ...
    { id: "professional_training", cluster: "special", name: "הכשרה מקצועית" },
...
const informationSources = [
  ...
  {
    title: "נציבות שוויון זכויות: נגישות באירועים וכנסים",
    type: "הנחיה רשמית",
    use: "דף נושא רשמי לריכוז זכויות, מדריכים והתאמות באירועים וכנסים הפתוחים לציבור.",
    url: "https://www.gov.il/he/departments/topics/accessibility_at_events_and_conferences",
  },
  {
    title: "נציבות שוויון זכויות: נגישות בחינוך, הכשרה והשכלה גבוהה",
    type: "הנחיה רשמית",
    use: "דף נושא רשמי לבדיקת מוסדות חינוך, הכשרה מקצועית והשכלה גבוהה לצד הוראות הדין הייעודיות.",
    url: "https://www.gov.il/he/departments/topics/education_training_and_higher_education_accessibility",
  },
  {
...
informationSources.push(
  {
    title: "נציבות שוויון זכויות: מידע משפטי",
    category: "מחייב / מאגר ניווט",
    use: "איתור מידע משפטי, חקיקה, תקנות והנחיות נציבות לפי נושא; נקודת בדיקה לעדכון שוטף.",
    verification: "מאגר רשמי. כל קביעה בדוח מחייבת פתיחת הנוסח המקורי, אימות תחילה, מהדורה ותחולה.",
    url: "https://www.gov.il/he/collectors/legalinfo?OfficeId=9a6c04df-2d47-4764-9139-37f085b5965c",
  },
  {
...
// אירוע נבדק כתהליך שלם, ולא כצילום או כפריט פיזי יחיד.
catalog.checklistTemplates.event = [
  surveyItem("EV-INFO", "פרסום מידע והסדרי נגישות", "בדוק שהפרסום כולל הסדרי נגישות, פרטי קשר לבקשת התאמה ומידע עדכני על מקום האירוע.", ["תקנות נגישות השירות לפי תחולה", "נציבות שוויון זכויות: נגישות באירועים וכנסים - מדריך"]),
  surveyItem("EV-REGISTRATION", "הרשמה ובקשת התאמות", "בדוק שתהליך ההרשמה נגיש ושאפשר לבקש התאמה באופן ברור, מכבד ומעשי לפני האירוע.", ["תקנות נגישות השירות לפי תחולה", "נציבות שוויון זכויות: זכויות נגישות באירועים וכנסים"]),
  surveyItem("EV-ARRIVAL", "הגעה, חניה, הורדה וכניסה", "בדוק מידע הגעה נגיש, חניה או נקודת הורדה, דרך רציפה וכניסה נגישה למקום האירוע.", ['ת"י 1918 לפי תחולה', "נציבות שוויון זכויות: נגישות באירועים וכנסים - מדריך"]),
  surveyItem("EV-PLACE", "מעברים, דלפקים ושירותים במקום", "בדוק רצף פנימי נגיש בין כניסה, קבלה, אזור פעילות, מזון או שתייה, שירותים ויציאה.", ['ת"י 1918 לפי תחולה', "תקנות נגישות השירות לפי תחולה"]),
  surveyItem("EV-SEATING", "מקומות ישיבה וצפייה", "בדוק מקומות ישיבה נגישים, מקום למלווה, רצף הגעה ונראות או חלופה מתאימה לתוכן האירוע.", ["תקנות נגישות השירות לפי תחולה", "נציבות שוויון זכויות: נגישות באירועים וכנסים - מדריך"]),
  surveyItem("EV-STAGE", "במה, דוברים והשתתפות", "כאשר משתתפים או דוברים נדרשים להגיע לבמה, בדוק דרך הגעה נגישה, חלופת השתתפות ומידע מוקדם על ההתאמה.", ['ת"י 1918 לפי תחולה', "נציבות שוויון זכויות: נגישות באירועים וכנסים - מדריך"]),
  surveyItem("EV-COMMUNICATION", "נגישות תקשורת ומידע", "בדוק התאמות נדרשות לשמיעה, ראייה ותקשורת, כגון כתוביות, תמלול, תרגום לשפת סימנים, לולאת השראה או חלופה אחרת לפי אופי האירוע והבקשה.", ["תקנות נגישות השירות לפי תחולה", "נציבות שוויון זכויות: זכויות נגישות באירועים וכנסים"]),
  surveyItem("EV-SIGNAGE", "שילוט, הכוונה ומידע זמני", "בדוק ששילוט זמני, עמדות שירות והנחיות התמצאות ברורים, קריאים וזמינים לאורך האירוע.", ['ת"י 1918 חלק 6 לפי תחולה', "נציבות שוויון זכויות: נגישות באירועים וכנסים - מדריך"]),
  surveyItem("EV-STAFF", "צוות, סיוע ונוהל פניות", "בדוק שהצוות מכיר את הסדרי הנגישות, יודע לתת סיוע לפי צורך ויודע למי להפנות בקשת התאמה או תלונה.", ["תקנות נגישות השירות לפי תחולה", "נציבות שוויון זכויות: נגישות באירועים וכנסים - מבוא"]),
  surveyItem("EV-EMERGENCY", "פינוי ומידע בחירום", "בדוק נתיב יציאה נגיש, דרך מסירת מידע בחירום וסיוע למשתתפים הזקוקים לכך; אימות בטיחותי ייעשה מול גורם מוסמך.", ["הוראות בטיחות וחירום לפי תחולה", "נציבות שוויון זכויות: נגישות באירועים וכנסים - מדריך"]),
];
...
catalog.checklistTemplates.higher_education = [
  surveyItem("HE-ARRIVAL", "הגעה ומבני קמפוס", "בדוק מסלולים בין מבנים, חניה, כניסה, מעליות ושילוט, לפי הוראות מוסד השכלה גבוהה קיים והתחולה בפועל.", ["תקנות התאמות נגישות למוסדות ושירותי השכלה גבוהה, תשע״ו-2016", 'ת"י 1918 חלקים 2 ו-3.1']),
  surveyItem("HE-LEARNING", "כיתות, אולמות ומעבדות", "בדוק מקומות ישיבה, במה, עמדות הוראה, מעבדות וציוד, וכן אפשרות להשתתפות שוויונית בלמידה.", ["תקנות התאמות נגישות למוסדות ושירותי השכלה גבוהה, תשע״ו-2016", 'ת"י 1918 חלק 3.1']),
  surveyItem("HE-ACADEMIC", "קבלה, הוראה והתאמות לימוד", "בדוק מידע נגיש למועמדים, דרך פנייה לבקשת התאמה, חומרי לימוד, בחינות והוראה; התאמה פרטנית תיבחן לפי הצורך והמסלול החוקי החל.", ["חוק שוויון זכויות לאנשים עם מוגבלות, סעיפים 19ל ו-19לא", "נציבות שוויון זכויות: נגישות בחינוך, הכשרה והשכלה גבוהה"]),
  surveyItem("HE-SERVICE", "רישום, ספרייה ושירותי סטודנטים", "בדוק מידע, טפסים, שירות דיגיטלי, ספרייה וליווי.", ["תקנות התאמות נגישות למוסדות ושירותי השכלה גבוהה, תשע״ו-2016", 'ת"י 5568 חלקים 1 ו-2']),
  surveyItem("HE-HOUSING", "מעונות ויחידות אירוח", "בדוק לפי תחולה מסלולים, חדרים, שירותים ושירותים נלווים.", ['ת"י 1918 חלק 3.1']),
  surveyItem("HE-PROFESSIONAL", "תכנית הנגשה ואימות מקצועי", "בדוק שקיימת תכנית הנגשה ושאישורים או היוועצות של מורשי נגישות מבוצעים כאשר הדין מחייב זאת; אין להסיק מהיעדר מסמך על עמידה או אי-עמידה.", ["חוק שוויון זכויות לאנשים עם מוגבלות, סעיף 19ל", "נציבות שוויון זכויות: מורשה נגישות השירות"]),
];

catalog.checklistTemplates.professional_training = [
  surveyItem("PT-ARRIVAL", "הגעה, כניסה ומסלולים", "בדוק הגעה, כניסה, מסלולים, מפלסים, שירותים ושילוט במתחם ההכשרה לפי תחולה.", ['ת"י 1918 לפי תחולה', "תקנות נגישות השירות לפי תחולה"]),
  surveyItem("PT-LEARNING", "כיתות, סדנאות וציוד הכשרה", "בדוק עמדות לימוד, סדנאות, ציוד מקצועי, הוראות בטיחות ויכולת השתתפות של לומד עם מוגבלות.", ["תקנות נגישות השירות לפי תחולה", "נציבות שוויון זכויות: נגישות בחינוך, הכשרה והשכלה גבוהה"]),
  surveyItem("PT-MATERIALS", "חומרי לימוד, מידע והערכה", "בדוק חומרי לימוד, מצגות, טפסים, מבחנים או הערכות, ומסלול לבקשת התאמה; התאמה פרטנית תתועד ותאומת לפי הדין החל.", ["תקנות נגישות השירות לפי תחולה", 'ת"י 5568 חלקים 1 ו-2']),
  surveyItem("PT-SERVICE", "רישום, ייעוץ וליווי", "בדוק שהרישום, המידע, הייעוץ והליווי זמינים באופן נגיש ושיש איש קשר לבקשות התאמה.", ["תקנות נגישות השירות לפי תחולה", "נציבות שוויון זכויות: נגישות בחינוך, הכשרה והשכלה גבוהה"]),
  surveyItem("PT-EMERGENCY", "בטיחות, פינוי וסיוע", "בדוק מידע חירום, התרעות, נתיב פינוי וסיוע, בהתאמה לסיכוני ההכשרה ולתכנית החירום המאושרת.", ["הוראות בטיחות וחירום לפי תחולה"]),
];
...
catalog.checklistTemplates.education = [
  surveyItem("ED-ARRIVAL", "הגעה, הורדה וכניסה", "בדוק חניה או הורדה, מסלול נגיש, כניסה, שער ודלתות; אמת את מסלול התחולה של מוסד החינוך הקיים או החדש.", ["תקנות התאמות נגישות במוסד חינוך קיים, תשע״א-2011", 'ת"י 1918 חלקים 2 ו-3.1']),
  surveyItem("ED-CLASS", "כיתות, מעבדות וחללי למידה", "בדוק מעבר, מרחב תמרון, עמדות לימוד, לוחות, ציוד ומידע נגיש, לצד התאמות אישיות הנדרשות להשתתפות.", ["תקנות התאמות נגישות במוסד חינוך קיים, תשע״א-2011", "תקנות נגישות השירות"]),
  surveyItem("ED-PLAY", "חצר, משחקים ופעילות חוץ", "בדוק רצף מסלול, משטחים, מתקנים, ישיבה והשגחה בהתאם לתחולה.", ['ת"י 1918 חלק 2']),
  surveyItem("ED-SERVICE", "מזכירות, מידע וליווי", "בדוק רישום, מידע, תקשורת, שירות חלופי וליווי לתלמיד או הורה, לרבות דרך ברורה לבקשת התאמה.", ["תקנות נגישות השירות", "נציבות שוויון זכויות: נגישות בחינוך, הכשרה והשכלה גבוהה"]),
